...
-- Brightness Control
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessctl -q s +5% && notify-send -t 1000 -h string:x-canonical-private-synchronous:brightness \"Brightness\" \"$(brightnessctl -m | awk -F, '{print $4}')\""))
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl -q s 5%- && notify-send -t 1000 -h string:x-canonical-private-synchronous:brightness \"Brightness\" \"$(brightnessctl -m | awk -F, '{print $4}')\""))

-- Sound Control
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+ && notify-send -t 1000 -h string:x-canonical-private-synchronous:volume \"Volume\" \"$(wpctl get-volume @DEFAULT_AUDIO_SINK@ | awk '{vol=int($2*100); muted=$3==\"[MUTED]\"?1:0; if(muted) print vol\"% (MUTED)\"; else print vol\"%\";}')\""))
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%- && notify-send -t 1000 -h string:x-canonical-private-synchronous:volume \"Volume\" \"$(wpctl get-volume @DEFAULT_AUDIO_SINK@ | awk '{vol=int($2*100); muted=$3==\"[MUTED]\"?1:0; if(muted) print vol\"% (MUTED)\"; else print vol\"%\";}')\""))
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && notify-send -t 1000 -h string:x-canonical-private-synchronous:volume \"Volume\" \"$(wpctl get-volume @DEFAULT_AUDIO_SINK@ | awk '{vol=int($2*100); muted=$3==\"[MUTED]\"?1:0; if(muted) print \"MUTED (\"vol\"%)\"; else print vol\"%\";}')\""))
